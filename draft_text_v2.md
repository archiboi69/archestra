...
While both German and Polish examples demonstrate the viability of collective self-development models, several critical gaps emerge when comparing these approaches. German Baugruppen projects have achieved maturity through decades of implementation, creating established frameworks and professional support systems. In contrast, Polish initiatives remain in an experimental phase, adapting various aspects of collaborative housing without fully developed methodologies or support structures. Identifying these gaps is essential for developing a more effective approach to collective self-development in Poland.
...
First let's outline the procedure.
0. Envision
1. find a plot
2. analyse the feasibility of the plot
3. Develop architectural wireframe while keeping flexibility7


## Envisioning
- Poznań was chosen as the general location for the project
- a middle size apartment block for 9-15 households in a central location
- aimed at young entrepreneurial families that aim higher in life than the developer slop
...
- coop is better when it is targeted at people who cannot be easily served by a developer (eg. young urban families), Gdynia was people who didnt get a better space because of the coop, but they got any space. 
...
For it to be desirable it has to address concerns - mainly be fairly easy, understandable, with clear benefits and mitigated risks.

Specific objectives:
1. A 9-15 unit collective self-development project
2. Clear target group - young urban families, people with high agency, that want something better than on the market (that want big, customised central apartments) and are willing to get involved to get it
3. Location - a plot that is zoned for multi-family residential, but not big enough to be attractive for a developer; preferably a brownfield, urban infill or renewal location.
4. Develop the design as if Implementing K20's procedure - go theoretically through interest community and planning community - present the project as if looking for a building community
4. Allow for communal amenities as this can ensure long-term satisfaction
5. Develop commercial space to bring value to the city, potentially get extra rent or pay back for municipal land
3. Demonstrate saving vs. a comparable developer 
8. Demonstrate benefit for the city and neighbourhood 
4. Show a detail cost breakdown to ease financing concerns 
3. Branding - a new way of coopertism; not like spoldzielnia; for entrepreneurial active amazing people that are better developer than developer - self-development